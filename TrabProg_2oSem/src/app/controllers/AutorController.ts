...
class AutorController{
    ...
    async list(req: Request, res: Response){
        const repository = getRepository(Autor);
    ...
    async store(req: Request, res: Response){
        ...
        const repository = getRepository(Autor);//recupera o repositorio do Autor.
    ...
    async update(req: Request, res: Response){
        ...
        async delete(req: Request, res: Response){
            ...
            const repository = getRepository(Autor);//recupera o repositorio do jogador.
